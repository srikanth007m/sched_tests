...
TESTNAME="MP_PMU_TEST_SCN04"

PROG="$TOOLS/cache"

CFG_VALS_A7="0xFF 0x04 0x03"
CFG_NAMES="cpu_cycles cache_references cache_misses"
...
for I in ${SCALES[@]}; do
	PARAM="-o $I.dat -x, -e $CFG_STR $__TASKSET $MASK $PROG -l $I"
